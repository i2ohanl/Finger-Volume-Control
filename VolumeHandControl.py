...
# volume.GetMute() __not used__
# volume.GetMasterVolumeLevel() __not used__
...
while True:
    ...
    if len(lmList) != 0:
        ...
        length_active = math.hypot(x3-x2, y3-y2)
        ...
        vol = np.interp(length, [40, 190], [-63.5, 0])
        print(length_active, vol)
        if length_active < 30:
